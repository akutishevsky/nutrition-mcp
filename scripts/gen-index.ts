            ...
            <section class="section" id="stats">
                <div class="container" data-reveal>
                    ...
                    <div class="facts" id="stat-row" data-reveal>
                        <p class="facts-title">${esc(doc.stats.factsTitle)}</p>
...
for (const [locale, doc] of Object.entries(INDEX) as [SiteLocale, IndexDoc][]) {
    const file =
        locale === "en"
            ? "./public/index.html"
