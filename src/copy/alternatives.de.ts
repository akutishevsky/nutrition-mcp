    ...
    "lose-it-mcp": {
        ...
        importSection: {
            ...
            body: [
                ...
                'Zwei Lose-It!-Besonderheiten werden gezielt behandelt. Sein Export trägt ein Gelöscht-Flag, und als gelöscht markierte Zeilen werden übersprungen statt importiert: Sie zurückzubringen würde absichtlich entferntes Essen wiederbeleben, und keine Summe in der Vorschau würde das aufdecken. Außerdem schreibt er den wörtlichen String „n/a" für Zellen ohne Wert, was als leer gelesen wird statt als Null — ein nie erfasster Makro bleibt also abwesend, statt als echte 0 g erfasst zu werden und deine Durchschnitte nach unten zu ziehen.',
