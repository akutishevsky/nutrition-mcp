        ...
        slides: [
            {
                ...
                description:
                    "Скажи, що ти з'їв і випив, так, як розповів би другові. Калорії, макронутрієнти, клітковина й кофеїн порахуються, а час визначиться сам.",
                messages: [
                    {
                        from: "user",
            ...
            },
            {
                ...
                description:
                    "Надішли фото — і він з'ясує, звідки страва, перевірить твої минулі записи, а тоді ставитиме по одному короткому запитанню. Лише за фото він нічого не записує.",
                messages: [
                    ...
                    {
                        from: "ai",
                        text: "Зрозумів. Отже, тарілку борщу з яловичиною і 2 ст. л. сметани доїдено повністю, як і скибку житнього хліба: близько 470 ккал, 24 г білка. Записати як обід?",
                    },
                    { from: "user", text: "Так" },
                    {
                        from: "ai",
            ...
            },
            {
                ...
                description:
                    "Сфотографуй упаковку. Продукт знайдеться в Open Food Facts, перерахується на ту кількість, яку ти справді з'їв чи випив, а прогалини в його даних буде заповнено.",
                messages: [
                    {
                        from: "user",
                        photo: "package",
                    ...
                    {
                        from: "ai",
                        text: "Записано до обіду: 139 ккал, 35 г цукру, 0 г клітковини. В Open Food Facts немає даних про кофеїн, тож я взяв дані самої Coca-Cola: близько 32 мг на банку.",
                    },
                ],
            },
            {
                ...
                description:
                    "Встанови денні цілі й ліміти одним реченням, а потім спитай, як справи сьогодні і скільки ще лишилося.",
                messages: [
                    {
                        from: "user",
                    ...
                    {
                        from: "ai",
                        text: "Сьогодні в тебе 1 540 ккал і 104 г білка: до цілей ще 460 ккал і 56 г білка. Тож так, десерт приблизно на 200 ккал вміститься, якщо решта буде переважно білком.",
                    },
                ],
            },
            {
                ...
                messages: [
                    { from: "user", text: "Яким був минулий тиждень?" },
                    {
                        from: "ai",
            ...
            },
            {
                ...
                title: "Стеж за вагою",
                description:
                    "Запиши зважування в кг або фунтах і побач справжній тренд: зміну за місяць, згладжене середнє й відстань до цільової ваги.",
                messages: [
                    {
                        from: "user",
            ...
            },
            {
                ...
                description:
                    "Спитай, що впливає на те, скільки ти їси. Він порівнює будні з вихідними, дні зі сніданком і без нього, ранні вечері з пізніми.",
                messages: [
            ...
            },
            {
                ...
                description:
                    "Відстеження алкоголю вмикається за бажанням. Обери американські стандартні порції або британські одиниці — і кожен напій запишеться в грамах алкоголю за його об'ємом і міцністю.",
                messages: [
                    {
                        from: "user",
                    ...
                    {
                        from: "ai",
                        text: "Записано до вечері: пінта 568 мл міцністю 4% — це 18 г алкоголю, 2,3 британської одиниці, близько 180 ккал.",
                    },
                ],
            },
            {
                ...
                description:
                    "Переходиш із MyFitnessPal, Cronometer, Lose It! чи MacroFactor? Твій експорт читається в браузері, і нічого не зберігається, доки ти не підтвердиш.",
                messages: [
                    {
                        from: "user",
                    ...
                    {
                        from: "ai",
                        text: "Часовий пояс встановлено: America/Chicago. Тепер обери файл експорту в імпортері. Він читається у твоєму браузері, і нічого не зберігається, доки ти не підтвердиш попередній перегляд.",
                    },
                ],
            },
            {
                ...
                description:
                    "Один запит — і ти отримуєш ZIP з усіма прийомами їжі, записами води, зважуваннями, цілями й налаштуваннями, а файл із прийомами їжі можна одразу імпортувати назад.",
                messages: [
                    {
                        from: "user",
