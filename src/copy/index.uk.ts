        ...
        slides: [
            {
                ...
                description:
                    "Опиши страву так, як розповів би другові, — без пошуку в базі продуктів і без повзунків для порцій. Калорії, макронутрієнти й кофеїн порахуються та запишуться самі.",
            ...
            },
            {
                ...
                description:
                    "Надішли фото штрихкоду або введи його цифри. Продукт знайдеться в Open Food Facts і буде перерахований на ту кількість, яку ти справді з'їв чи випив.",
            ...
            },
            {
                ...
                description:
                    "Спитай, яким був тиждень, — і віджет трендів відкриється прямо в чаті. Перемикайся між 7, 14 і 30 днями або торкнися нутрієнта, щоб побачити його графік.",
